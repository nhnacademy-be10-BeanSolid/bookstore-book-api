...
public interface BookTagControllerDocs {
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    responseCode = "403", description = "접근 없음"
            )
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    responseCode = "404", description = "도서 태그를 찾을 수 없습니다."
            )
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    responseCode = "400", description = "잘못된 요청 또는 유효성 검증 실패"
            ),
            @ApiResponse(
                    responseCode = "403", description = "권한 없음"
            ),
            @ApiResponse(
                    responseCode = "409", description = "이미 존재하는 태그"
            )
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    responseCode = "404", description = "존재하지 않는 태그 ID"
            )
    })
