...
public interface BookLikeControllerDocs {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "조회 성공", content = @Content(schema = @Schema(implementation = BookLikeResponse.class))),
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "409", description = "이미 좋아요가 존재하는 경우")
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "도서 또는 좋아요 정보를 찾을 수 없음")
    })
