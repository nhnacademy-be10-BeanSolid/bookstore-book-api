...
public interface BookCategoryMapControllerDocs {
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공", content = @Content(schema = @Schema(implementation = BookCategoryMapResponse.class)))
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "생성 성공", content = @Content(schema = @Schema(implementation = BookCategoryMapResponse.class))),
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "도서 또는 카테고리 매핑을 찾을 수 없음")
    })
