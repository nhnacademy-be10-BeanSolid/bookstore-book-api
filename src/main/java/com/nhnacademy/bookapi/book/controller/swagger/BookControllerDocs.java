...
public interface BookControllerDocs {
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공", content = @Content(schema = @Schema(implementation = SimpleBookResponse.class)))
    ...
    @ApiResponse(responseCode = "200", description = "검색 성공", content = @Content(schema = @Schema(implementation = SimpleBookResponse.class)))
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공", content = @Content(array = @ArraySchema(schema = @Schema(implementation = BookOrderResponse.class))))
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "검증 실패", content = @Content(schema = @Schema(implementation = ValidationFailedException.class)))
    })
    ...
    @ApiResponse(responseCode = "204", description = "인덱스 최신화 성공")
